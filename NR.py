...
#foction t3tyha y li howa reviewer_id wl a li howa lproduit w length mt3 dataset  trj3lk 9addech l auteur heka ktab mn review 3al produit hetheka 
x = json_normalize(data) 
t= len(x)
def NR(a,y,t) :
   cpt=0
   for i in range(t):
      if y == x['reviewerID'][i] and a == x['asin'][i] :
          cpt= cpt+1     
   return cpt 
